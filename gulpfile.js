...
//Función que nos permite escuchar archivos JavaScript
function javascript(done) {
  //Ruta de fuente de nuestros archivos JavaScript
  src("src/js/**/*.js")
    // .pipe(sourcemaps.init())
    // .pipe(terser())
    // .pipe(sourcemaps.write("."))
...
function dev(done) {
  ...
  //Que mire o detecto los cambios en la carpeta y se llame a la función javascript
